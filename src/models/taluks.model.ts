...
taluks.belongsTo(blocks, {targetKey: 'taluk_id',foreignKey: 'taluk_id', constraints: false });
blocks.hasOne(taluks, { sourceKey: 'taluk_id', foreignKey: 'taluk_id', constraints: false });