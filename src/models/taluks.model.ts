...
taluks.belongsTo(places, {targetKey: 'taluk_id',foreignKey: 'taluk_id', constraints: false });
places.hasOne(taluks, { sourceKey: 'taluk_id', foreignKey: 'taluk_id', constraints: false });